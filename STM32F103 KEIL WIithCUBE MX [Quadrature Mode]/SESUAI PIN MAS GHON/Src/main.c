...
//	break;
//	
//	case 1: //mengambil data encoder sekarang
//							newEnc1 = enc_1;
//							newEnc2 = enc_2;
//							newEnc3 = enc_3;
//							newEnc4 = enc_4;
//	break;
//	
//	case 2: //calculate rpm
//						rpm[0] = ((newEnc1 - oldEnc1) *60000 / 548);
//						rpm[1] = ((newEnc2 - oldEnc2) *60000 / 548);
//						rpm[2] = ((newEnc3 - oldEnc3) *60000 / 548);
//						rpm[3] = ((newEnc4 - oldEnc4) *60000 / 548);
//	break;
//	
//	case 3: //send rpm
//	
...
void updateDataEncoder3(void) {
		...
		nilaiEnco3A = (uint8_t) ((GPIOA->IDR & GPIO_PIN_1) >> 0);
		nilaiEnco3B = (uint8_t) ((GPIOA->IDR & GPIO_PIN_0) >> 1);
...
void updateDataEncoder4(void) {
		...
		nilaiEnco4A = (uint8_t) ((GPIOB->IDR & GPIO_PIN_5) >> 4);
		nilaiEnco4B = (uint8_t) ((GPIOB->IDR & GPIO_PIN_4) >> 5);
